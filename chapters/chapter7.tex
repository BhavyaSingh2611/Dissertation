...
% [figure] Accessibility overview: required hardware tiers vs expected training/inference time.
...
The planned web platform addresses common web vulnerabilities in a few ways. All FEN strings and UCI moves received from clients are validated against \texttt{python-chess} before execution, preventing malformed input from reaching the model.
...
% [figure] Estimated energy use breakdown per training component (compute vs I/O).
