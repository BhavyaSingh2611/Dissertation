...
% [figure] Comparison schematic: search-based engine pipeline vs search-less inference pipeline (latency and compute stages).
...
% [figure] Log-scale bar chart comparing state space size, game-tree size, and feasible search budgets.
...
% [figure] Evaluation overview: Stockfish depth ladder and puzzle categories used for benchmarking.
