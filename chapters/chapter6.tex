...
Mixed-precision training requires platform-specific handling. The asymmetry between CUDA and MPS support for \texttt{GradScaler} required conditional logic that was non-obvious and initially caused silent numerical instability.
