...
\title{Searchless Chess: A comparative study of ML Models without Tree Search}
...
\usepackage{float}
\usepackage{caption}
\captionsetup[figure]{skip=4pt} % Adjust '4pt' to your preferred distance
% \usepackage{tikz}
...
% appendices
\appendix
\include{appendices/appendix_a_additional_results}
\include{appendices/appendix_b_user_guide}
\include{appendices/appendix_c_game_examples}
%\include{appendices/appendix_d_ethical_approval}
\nocite{*}
